                ...
                <div class="card card-body">
                    <form method="POST" action="{{ route('role.update', $role->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" class="form-control" id="inputRoleName" value="{{ old('name', $role->name) }}">
                            </div>
                        </div>
                        <fieldset class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <?php $permissionsStr = array_map('strval', $role->permissions->pluck('id')->toArray()); ?>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input name="permission[]" class="form-check-input" type="checkbox" id="checkboxForPermission_{{ $permission->id }}" value="{{ $permission->id }}"
                                            {{ in_array((string) $permission->id, old('permission', $permissionsStr), true) ? 'checked="checked"' : ''}}>
